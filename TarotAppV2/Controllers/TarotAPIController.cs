...
namespace TarotAppV2.Controllers
{
    ...
    public class TarotAPIController : ControllerBase
    {
        ...
        new TarotModel{Id =70, Name = "Seven of Wands",  Description="The Seven of Wands represents defensiveness, perseverance, determination, and resilience. It signifies standing your ground and protecting your beliefs or territory.", ImageId=70 },
